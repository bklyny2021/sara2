...
def status():
    ...
    try:
        ...
        if 'sara-boo1-fixed' in result.stdout:
            model_status = '🤖 SaraBoo1-fixed operational'
        else:
            model_status = '⚠️ SaraBoo1-fixe'
    except:
...
if __name__ == '__main__':
    print("🌟 SARA OFFLINE WEB INTERFACE")
    print("=" * 50)
    print("🚀 Starting web server...")
    print("🌐 Opening in browser... http://127.0.0.1:8890")
